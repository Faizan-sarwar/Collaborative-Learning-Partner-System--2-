...
const menuItems = [
  ...
  { id: 'students', label: 'Students', icon: 'students', path: '/admin/students' },
  { id: 'admins', label: 'Admins', icon: 'admins', path: '/admin/admins' },
  { id: 'courses', label: 'Courses', icon: 'courses', path: '/admin/courses' },
  { id: 'notifications', label: 'Notifications', icon: 'notifications', path: '/admin/notifications' },
  { id: 'logs', label: 'Activity Logs', icon: 'logs', path: '/admin/logs' },
