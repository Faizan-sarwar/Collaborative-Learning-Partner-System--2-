...
const DashboardSidebar = () => {
  ...
  const { settings } = useSettings(); // 🟢 Fixed to safely grab settings
  
  // State to hold notification badges
  const [badges, setBadges] = useState({});

  // Calculate where to put the Red Dots
  ...
  // Listen to global events to update dots instantly
  useEffect(() => {
    ...
    <aside className={styles.sidebar}>
      <div className={styles.header}>
        <div className={styles.logo}>
          ...
          {/* 🟢 MAGIC HAPPENS HERE: Falls back cleanly to 'Loading...' while fetching */}
