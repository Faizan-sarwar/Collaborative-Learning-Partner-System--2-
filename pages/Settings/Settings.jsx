    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Dark overlay with circular hole punched out */}
          <svg
          ...
          >
            ...
            <circle
              ...
              strokeDasharray="5 3"
            />
            {/* Rule-of-thirds grid lines inside circle only */}
            <clipPath id="circleClip">
              <circle cx={CIRCLE_CX} cy={CIRCLE_CY} r={CIRCLE_R} />
            </clipPath>
            <g clipPath="url(#circleClip)" stroke="rgba(255,255,255,0.18)" strokeWidth="1">
              {/* Vertical thirds */}
              <line x1={CIRCLE_CX - CIRCLE_R + CROP_SIZE / 3} y1={CIRCLE_CY - CIRCLE_R} x2={CIRCLE_CX - CIRCLE_R + CROP_SIZE / 3} y2={CIRCLE_CY + CIRCLE_R} />
              <line x1={CIRCLE_CX - CIRCLE_R + (CROP_SIZE / 3) * 2} y1={CIRCLE_CY - CIRCLE_R} x2={CIRCLE_CX - CIRCLE_R + (CROP_SIZE / 3) * 2} y2={CIRCLE_CY + CIRCLE_R} />
              {/* Horizontal thirds */}
              <line x1={CIRCLE_CX - CIRCLE_R} y1={CIRCLE_CY - CIRCLE_R + CROP_SIZE / 3} x2={CIRCLE_CX + CIRCLE_R} y2={CIRCLE_CY - CIRCLE_R + CROP_SIZE / 3} />
              <line x1={CIRCLE_CX - CIRCLE_R} y1={CIRCLE_CY - CIRCLE_R + (CROP_SIZE / 3) * 2} x2={CIRCLE_CX + CIRCLE_R} y2={CIRCLE_CY - CIRCLE_R + (CROP_SIZE / 3) * 2} />
            </g>
          </svg>
        </div>

        {/* Zoom bar */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', width: CONTAINER_W }}>
          <button
    ...
    <PageTransition>
      <div className={styles.settings}>
        ...
        <div className={styles.mainArea}>
          <DashboardHeader username={formData.fullName} toggleSidebar={() => setIsSidebarOpen(!isSidebarOpen)} />
                  ...
                  <motion.div variants={fadeVariants} initial="hidden" animate="visible">
                    ...
                    <div className={styles.formGrid}>
                      ...
                      <div className={styles.formGroup}>
                        ...
                        <input type="tel" value={formData.phone} placeholder="+1 (555) 000-0000" onChange={(e) => handleInputChange('phone', e.target.value)} />
                      </div>
