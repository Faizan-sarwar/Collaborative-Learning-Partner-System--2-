...
// Emails that sign up here are force-promoted to admin/super-admin on the backend
// (see the same list in AdminManagement.jsx). Keep both lists in sync.
...
const Signup = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (
        studyStyleRef.current &&
        !studyStyleRef.current.contains(event.target)
      )
  ...
  // If the typed email matches a designated admin email, this signup will
  // become an admin account on the backend — academic/learning fields are irrelevant for it.
  ...
  const validateHumanName = (name) => {
    ...
    if (/[\-']{2,}/.test(trimmedName) || /\s{2,}/.test(trimmedName))
      return "Name cannot contain consecutive spaces or symbols";
    if (/^[\-']|[\-']$/.test(trimmedName))
    ...
    if (
      trimmedName
        .toLowerCase()
        .split(/\s+/)
        .some((word) => blockedWords.includes(word))
    ) {
  ...
  const validateField = (name, value) => {
    switch (name) {
      ...
      case "password":
        ...
        return passwordIssues.length > 0
  ...
  // Admin accounts don't need academic/learning data — clear it out so nothing
  // stale gets sent if the user fills these in before/after typing an admin email.
  useEffect(() => {
    ...
    setErrors((prev) => ({ ...prev, studyStyle: "", availability: "" }));
  }, [isAdminEmail]);
  ...
  const handleSubjectToggle = (field, subjectName) => {
    if (
      field === "academicStrengths" &&
      !formData[field].includes(subjectName) &&
  ...
  const handleSubmit = async (e) => {
    ...
    const fieldsToValidate = [
      ...
      "semester",
      "acceptTerms",
      ...(isAdminEmail ? [] : ["studyStyle", "availability"]),
    ];
    ...
    try {
      ...
      Object.keys(formData).forEach((key) => {
        ...
        if (isAdminEmail && adminIrrelevantFields.includes(key)) return;
        ...
        <main className={styles.main}>
          ...
          >
            ...
            {formData.referredByCode && !alertError && !success && (
              ...
              >
                🎉 You've been invited by a friend! Sign up to claim your
                rewards.
              </motion.div>
            )}
            ...
            <form className={styles.form} onSubmit={handleSubmit} noValidate>
              ...
              <motion.div
                ...
                style={{
                  position: "relative",
                  zIndex:
                    departmentDropdownOpen || semesterDropdownOpen ? 50 : 1,
                }}
              >
                ...
                <div className={styles.formGrid}>
                  ...
                  <div className={styles.inputGroup}>{/* Blank space */}</div>
                  ...
                  <div
                    ...
                    style={{
                      position: "relative",
                      zIndex: departmentDropdownOpen ? 50 : 1,
                    }}
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <ChevronDown
                          size={18}
                          className={`${styles.dropdownIcon} ${departmentDropdownOpen ? styles.rotated : ""}`}
                        />
                      </div>
                  ...
                  <div
                    ...
                    style={{
                      position: "relative",
                      zIndex: semesterDropdownOpen ? 50 : 1,
                    }}
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <ChevronDown
                          size={18}
                          className={`${styles.dropdownIcon} ${semesterDropdownOpen ? styles.rotated : ""}`}
                        />
                      </div>
                ...
                <>
                  ...
                  <motion.div
                    ...
                    style={{
                      position: "relative",
                      zIndex:
                        strengthsDropdownOpen || difficultyDropdownOpen
                          ? 50
                          : 1,
                    }}
                  >
                    ...
                    <div className={styles.formGrid}>
                      <div
                        ...
                        style={{
                          position: "relative",
                          zIndex: strengthsDropdownOpen ? 50 : 1,
                        }}
                      >
                        ...
                        >
                          Your reliability quiz will be drawn only from these
                          subjects.
                        </small>
                        <div
                          className={styles.multiSelectWrapper}
                        ...
                        >
                          <div
                            className={styles.multiSelectTrigger}
                            onClick={() =>
                              setStrengthsDropdownOpen(!strengthsDropdownOpen)
                            }
                          >
                          ...
                          {strengthsDropdownOpen && (
                            <div className={styles.dropdownMenu}>
                              {availableSubjects
                                ...
                                .map((subjectObj) => {
                                  const isDisabled =
                                    formData.subjectsOfDifficulty.includes(
                                      subjectObj.name,
                                    );
                                  const isSelected =
                                    formData.academicStrengths.includes(
                                      subjectObj.name,
                                    );
                                  return (
                                    <div
                                      ...
                                      title={
                                        isDisabled
                                          ? "Already selected as a difficult subject"
                                          : ""
                                      }
                                    >
                      ...
                      <div
                        ...
                        style={{
                          position: "relative",
                          zIndex: difficultyDropdownOpen ? 50 : 1,
                        }}
                      >
                        <label className={styles.label}>
                          Subjects of Difficulty
                        </label>
                        <small
                          style={{
                            display: "block",
                        ...
                        >
                          Subjects you'd like help with — cannot overlap with
                          strengths.
                        </small>
                        <div
                          className={styles.multiSelectWrapper}
                                ...
                                .map((subjectObj) => {
                                  ...
                                  return (
                                    <div
                                      ...
                                      title={
                                        isDisabled
                                          ? "Already selected as a strength"
                                          : ""
                                      }
                                    >
                                      <span className={styles.itemCheckbox}>
                  ...
                  <motion.div
                    ...
                    style={{
                      position: "relative",
                      zIndex: studyStyleDropdownOpen ? 50 : 1,
                    }}
                  >
                    ...
                    <div className={styles.formGrid}>
                      ...
                      >
                        ...
                        <div
                          className={styles.singleSelectWrapper}
                          ref={studyStyleRef}
                        >
                          <div
                            className={styles.singleSelectTrigger}
                            onClick={() =>
                              setStudyStyleDropdownOpen(!studyStyleDropdownOpen)
                            }
                          >
                            <span
                              className={
                            ...
                            <ChevronDown
                              size={18}
                              className={`${styles.dropdownIcon} ${studyStyleDropdownOpen ? styles.rotated : ""}`}
                            />
                          </div>
                    ...
                    >
                      <label className={styles.label}>
                        Describe your available study times
                      </label>
                      <textarea
                        name="availability"
              ...
              <motion.button
                ...
                style={{
                  opacity: !formData.acceptTerms || isSubmitting ? 0.6 : 1,
                }}
                whileHover={
                ...
                whileTap={
                  !formData.acceptTerms || isSubmitting ? {} : { scale: 0.97 }
                }
